	    ...
	    <div class="row data-block">
	        ...
	        <div class="col-sm-3 form-group">
	        	<select name="verified" class="form-control">
	        		<option value="0" {{ ($listing->verified == false) || Input::old('verified') == "0" ? 'selected' : '' }}>No</option>
	        		<option value="1" {{ ($listing->verified == true) || Input::old('verified') == "1" ? 'selected' : '' }}>Yes</option>
	        	</select>
	        </div>
	    </div>
	    ...
	    <div class="row data-block">
	        ...
	        <div class="col-sm-3 form-group">
	        	<select name="approved" class="form-control">
	        		<option value="0" {{ ($listing->approved == false) || Input::old('approved') == "0" ? 'selected' : '' }}>No</option>
	        		<option value="1" {{ ($listing->approved == true) || Input::old('approved') == "1" ? 'selected' : '' }}>Yes</option>
	        	</select>
	        </div>
	    </div>
	        ...
	        <div class="col-sm-5 form-group">
	        	<select name="user" class="form-control selectpicker show-tick" data-live-search="true">
	        		...
	        		@foreach($users as $user)
	        			<option value="{{$user->id}}" {{ ($listing->user_id == $user->id) || Input::old('user') == $user->id ? 'selected' : '' }}>{{$user->email}}</option>
	        		@endforeach
	        	</select>
	        </div>
	    </div>
